...
import com.asdtechlabs.whatshack.FullScreenPreview;
import com.asdtechlabs.whatshack.R;
import com.asdtechlabs.whatshack.SelectionActivity;
...
public class ImageGalleryAdapter extends RecyclerView.Adapter<ImageGalleryAdapter.MyViewHolder> {
    ...
    public ImageGalleryAdapter(Context context, ArrayList<File> filePath) {
        mContext = context;
