...
import com.asdtechlabs.whatshack.activities.FullScreenPreview;
...
public class ImageAdapter extends PagerAdapter{
    ...
    int height, width;
    public ImageAdapter(Context context, int position, ArrayList files, String type, File path, int height, int width) {
